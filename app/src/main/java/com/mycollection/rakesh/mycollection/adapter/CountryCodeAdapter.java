...
public class CountryCodeAdapter extends RecyclerView.Adapter<CountryCodeAdapter.CountryCodeViewHolder> {
    ...
    public CountryCodeAdapter(Context context, List<Country> countries, final EditText editText_search, TextView textView_noResult) {
    ...
    private List<Country> getFilteredCountries(String query) {
        ...
        /*if(Singleton.getCountryList()!=null && Singleton.getCountryList().size()>0) {
            for (CountryActivity country : Singleton.getCountryList()) {
    ...
    public CountryCodeViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View rootView = inflater.inflate(R.layout.single_item, viewGroup, false);
        ...
        countryCodeViewHolder.getMainView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (view != null && filteredCountries.get(i)!=null) {
                    ...
                    Toast.makeText(context,filteredCountries.get(i).getName(),Toast.LENGTH_SHORT).show();
                    //countryName.setText(filteredCountries.get(i).getName());
                    //dialog.dismiss();
                }
            }
        });
